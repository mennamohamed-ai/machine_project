...
- **Generated Visualizations:**
  ...
  - `learning_lr.png` - Learning curve
...
- **Generated Visualizations:**
  ...
  - `validation_knn.png` - Validation curve
...
└── bank_loan_outputs/
    ...
    ├── cm_lr.png            # Confusion matrix for linear regression
    ├── roc_lr.png           # ROC curve for linear regression
    ├── learning_lr.png      # Learning curve for linear regression
    ├── cm_knn.png           # Confusion matrix for KNN
    ├── roc_knn.png          # ROC curve for KNN
    └── validation_knn.png   # Validation curve for KNN
```
...
- **Generated Visualizations:**
  ...
  - `learning_curve_logistic.png` - Learning curve
...
- **Generated Visualizations:**
  ...
  - `inertia_vs_k.png` - Inertia vs number of clusters
...
- Applied learning curves and validation curves to assess model generalization ability
